...
<div id="page-content">
  <div class="container">
    <div class="row justify-content-left">
      <div class="col-md-12">
        <h1 class="font-weight-light mt-4">ユーザ新規</h1>
          ...
          <form action="" method="post" class="form-horizontal" novalidate>
            ...
            <div class="form-group mb-3">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="role" id="inline_radio_1" value="{{ App\Models\User::ADMIN }}" @if(old('role') <= App\Models\User::CHIEF) checked @endif>
                <label class="form-check-label" for="inline_radio_1">管理者</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="role" id="inline_radiox_2" value="{{ App\Models\User::MEMBER }}" @if(old('role') == App\Models\User::MEMBER) checked @endif>
